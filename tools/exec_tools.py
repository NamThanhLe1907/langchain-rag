...
class VectorStoreRetriever:
    ...
    def from_docs(cls, docs, oai_client):
        vectors = hf_embeddings.embed_documents([doc["page_content"] for doc in docs])
        return cls(docs, vectors, oai_client)

    def query(self, query: str, k: int = 5) -> list[dict]:
        query_vector = hf_embeddings.embed_query(query)
        scores = query_vector @ self._arr.T  # Phép nhân ma trận
...
retriever = VectorStoreRetriever.from_docs(docs, hf_embeddings)
